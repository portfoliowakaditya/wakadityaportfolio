...
<Grid bsClass = 'container-fluid' className = {css(styles.padder)}>
                ...
                <div style={ sectionStyle } className = {css(styles.sectionstyle)} bsClass = "container-fluid">
                    ...
                    <font className = {css(styles.block1)}>textttxttxtextrtrtrtrtrtrtt </font> <font className = {css(styles.block2)}>ttettttrtrtrttxtt </font> <font className = {css(styles.block3)}>txtxxxxxtx </font>
                            ...
                            <p className={css(styles.subtitle)}>   I am an aspiring <b>Data Scientist</b>, with a Master's Degree from University of Washington. With a diverse perspective towards software and data systems, I aim to design information experiences which are interdisciplinary, to bridge the gap between customers, business and engineering.
                            </p>
                    </Col>
                            </Row>
